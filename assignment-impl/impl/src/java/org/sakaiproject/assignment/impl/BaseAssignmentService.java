...
//	spring service injection
			...
			IdInvalidException, IdUsedException, IdUnusedException
	{
		...
		if (assignmentReference != null)
		{
			...
			else
			{
				...
				retVal.setHorasEstimadas(existingAssignment.getHorasEstimadas());
			...
			IdInvalidException, IdUnusedException
	{
		...
		if (contentReference != null)
		{
			...
			else
			{
				...
				retVal.setHorasEstimadas(existingContent.getHorasEstimadas());
				...
				else
				{
					try
					{
						...
						else
						{
							...
							nContent.setHorasEstimadas(oContent.getHorasEstimadas());
					...
					if (nContent != null)
					{
						try
						{
							...
							nAssignment.setHorasEstimadas(oAssignment.getHorasEstimadas());
	...
	public class BaseAssignment implements Assignment
	{
		...
		protected String horasEstimadas;
		...
		public BaseAssignment(Element el)
		{
			...
			horasEstimadas = el.getAttribute("horasEstimadas");
						...
						Attributes attributes) throws SAXException
				{
					if (doStartElement(uri, localName, qName, attributes))
					{
						if ("assignment".equals(qName) && entity == null)
						{
							...
							horasEstimadas = attributes.getValue("horasEstimadas");
		...
		public Element toXml(Document doc, Stack stack)
		{
			...
			assignment.setAttribute("horasEstimadas", horasEstimadas == null ? "" : horasEstimadas);
		...
		protected void setAll(Assignment assignment)
		{
			if (assignment != null)
			{
				...
				horasEstimadas = assignment.getHorasEstimadas();
	...
	public class BaseAssignmentEdit extends BaseAssignment implements AssignmentEdit, SessionBindingListener
	{
		...
		public void setHorasEstimadas(String horas)
		{
	...
	public class BaseAssignmentContent implements AssignmentContent
	{
		...
		public Element toXml(Document doc, Stack stack)
		{
			...
			content.setAttribute("horasEstimadas", horasEstimadas == null ? "" : horasEstimadas);
		...
		protected void setAll(AssignmentContent content)
		{
			if (content != null)
			{
				...
				horasEstimadas = content.getHorasEstimadas();
			...
			SessionBindingListener
	{
		...
		public void setHorasEstimadas(String h) {
			horasEstimadas = h;
		}
	...
	public class BaseAssignmentSubmission implements AssignmentSubmission
	{
		...
		protected String m_horasEmpleadas;
...
//			 Code to get updated report if default
		...
		public BaseAssignmentSubmission(Element el)
		{
			...
			m_horasEmpleadas = el.getAttribute("horasEmpleadas");
			System.out.println("10952: "+ m_horasEmpleadas);
						...
						Attributes attributes) throws SAXException
				{
					if (doStartElement(uri, localName, qName, attributes))
					{
						if ("submission".equals(qName) && entity == null)
						{
							...
							m_horasEmpleadas = (String) attributes.getValue("horasEmpleadas");
							System.out.println("11173: "+ m_horasEmpleadas);
		...
		public Element toXml(Document doc, Stack stack)
		{
			...
			System.out.println("11259"+ m_horasEmpleadas);
			submission.setAttribute("horasEmpleadas", m_horasEmpleadas);
		...
		protected void setAll(AssignmentSubmission submission)
		{
			...
			m_horasEmpleadas = submission.getHorasEmpleadas();
			System.out.println("11372 "+ m_horasEmpleadas);
		...
		public String getHorasEmpleadas()
		{
			return m_horasEmpleadas;
		}
			...
			SessionBindingListener
	{
		...
		@Override
		public void setHorasEmpleadas(String horas) {

			this.m_horasEmpleadas = horas;
		}
