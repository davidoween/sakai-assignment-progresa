...
public class AssignmentEntityProvider extends AbstractEntityProvider implements EntityProvider, 
	...
	public class SimpleAssignment {
		...
		public SimpleAssignment(Assignment a) {
			...
			this.horasEstimadas = a.getHorasEstimadas();
	...
	public Map<String, Object> getAssignmentDeepLinks(EntityView view,
		...
		try {
			...
			assignData.put("assignmentId", assignmentId);
			assignData.put("assignmentTitle", a.getTitle());
			assignData.put("assignmentHorasEstimadas", a.getHorasEstimadas());
	...
	public Map<String, String> getProperties(String reference) {
		...
		try {
			...
			props.put("horasEstimadas", assignment.getHorasEstimadas());
